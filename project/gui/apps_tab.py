...
def create_apps_tab(notebook):
    ...
    ttk.Button(btn_frame, text="Buscar Apps", command=run_listar_paquetes).pack(side="left", padx=5)
    ttk.Button(btn_frame, text="Abrir App Seleccionada", command=open_selected_app).pack(side="left", padx=5)
    ttk.Button(btn_frame, text="Cerrar Apps", command=close_selected_app).pack(side="left", padx=5)
    ttk.Button(btn_frame, text="Detener Busqueda", command=detener_busqueda).pack(side="left", padx=5)
    ttk.Button(btn_frame, text="Copiar Ruta", command=copy_base_apk_path).pack(side="left", padx=5)
